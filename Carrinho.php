                ...
                ?>
                    ...
                    <table cellpadding="0" cellspacing="0" align="center">
                        <tr>
                            <td align="right">
                                <font class="texto3">
                                    <h3>Você possui <?php echo $num_produtos_carrinho; ?> produto(s) em seu carrinho</h3>
                                </font>
                            </td><br>
                        </tr>
                    </table>
                    ...
                    <table border="0" cellspacing="0" cellpadding="3" class="tablecarrinho" align="center">
                        ...
                        ?>
                            ...
                            <tr>
                                <td class="tdcarrinho">
                                    <font class="texto10"><?php echo $produto; ?></font>
                                </td>
                                <td align="center" class="tdcarrinho">
                                    <font class="texto10"><?php echo $qtd; ?></font>
                                </td>
                                <td align="center" class="tdcarrinho">
                                    <font class="texto10"><?php echo $preco; ?></font>
                                </td>
                                <td align="center">
                            ...
                            <table cellpadding="0" cellspacing="8" border="0" class="tableerro" align="center">
                                ...
                                <tr>
                                    <td align="center">
                                        <font class="texto9">
                                            <h2>Você precisa efetuar o Login!</h2><br><br><br>
                                        </font>
                                    </td>
                                </tr>
                            </table>
                            <table align="center" cellpadding="0" cellspacing="8" border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font color=black><input class="campo1" type="text" name="email" size="30" maxlength="30"></font>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <font color=black><input class="campo1" type="password" name="senha" size="30" maxlength="8" /></font>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <br>
                            <font class="texto3" align="center">
                                <center>Se você não possui cadastro, <a class="link1" href="Cadastro.php" target='principal'>clique aqui</a> e cadastre-se gratuitamente.
                            </font>
                            </center>
                            <br /><br /><br /><br />
                        <?
