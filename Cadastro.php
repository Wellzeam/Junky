...
<h3><center><br><font size=15> Cadastro de Usuário - Junky </font></center><br>

<center><font size="2" face="verdana" color="red"><b>Atenção: Todos os campos devem ser Preenchidos</b></font></center>
...
<table cellspacing="5" border="0" cellpadding="2" align="center">
  <tbody>
    ...
    <tr>
      ...
      <td><font face="arial" color=black><input type="password" name="senha" size="8" maxlength="8" class='campo1'></font><font size=3>&nbsp;Máximo 8, Mínimo 4 Caracteres</font></td>
    </tr>
    <tr>
      <td class="texto3">Confirma Senha:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
      <td><font face="arial" color=black><input type="password" name="confirmasenha" size="8" maxlength="8" class='campo1'></font><font size=3>&nbsp;Máximo 8, Mínimo 4 Caracteres</font></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><font face="arial" color=black><input type="text" name="bairro" size="20" class='campo1'></font></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><font face="arial" size=3 color=black>
    ...
    <tr>
      ...
      <td><font face="arial" color=black><input type="text" name="cep" size="15" class='campo1' maxlength='8'></font><font size=3>&nbsp;Apenas números</font></td>
    </tr>
    <tr>
      <td class="texto3">Telefone:</td>
      <td><font face="arial" color=black><input type="text" name="fone" size="15" class='campo1'></td></font>
    </tr>
    <tr>
      <td class="texto3">RG:</td>
      <td><font face="arial" color=black><input type="text" name="rg" size="15"  maxlength='10' class='campo1'></td></font>
    </tr>
    <tr>
      <td class="texto3">CPF:</td>
      <td><font face="arial" color=black><input type="text" name="cpf" size="15" class='campo1' maxlength='11'></font><font size=3>&nbsp;Sem pontuação<br><br></font></td>
    </tr></h3>
    <tr height="35">
