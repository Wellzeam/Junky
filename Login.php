            ...
            <table cellspacing="5" cellpadding="0" align="center">
                <tr>
                    <td align="center" valign='top' colspan='2' height='50'>
                        <h2>Autenticação de Usuário<br><br></h2>
                    </td>
                </tr>
                <form action="validalogin.php" target="pri" method="post">
                    <tr>
                        ...
                        <td>
                            <font color=black><input type="text" name="email" size="30" class='campo1'></font>
                        </td>
                    </tr>
                    <tr>
                        <td class='texto3'>
                        ...
                        <td>
                            <font color=black><input type="password" name="senha" size="30" maxlength="8" class='campo1'></font>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="center" valign='bottom'><br><button type="submit" class="btn btn-default ">Entrar</button></td>
                        </font>
                    </tr>
                </form>
                <tr>
                    <td align="center" height='30'><br><a class="link1" href="Cadastro.php" target="pri">
