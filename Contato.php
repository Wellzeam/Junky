...
<body data-spy="scroll" data-target="#navbar-menu" data-offset="100">
    ...
    <header id="hello">
        ...
        <h3>
            <center><br>
                <font size=15> Contato - Junky </font>
            </center><br>
        </h3>
        <h4>
            <center>
                <form action=v_Contato.php method=POST>
                    ...
                    <table cellspacing="5" border="0" cellpadding="2" align="center">
                        ...
                        <tr>
                            ...
                            <td>
                                <font face="arial" color=black><input type="text" name="telefone" size="35" class='campo1'></font>
                            </td>
                        </tr>
                        <tr>
                            <td class="texto3">Empresa:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            <td>
                                <font face="arial" color=black><input type="text" name="empresa" size="35" class='campo1'></font>
                            </td>
                        </tr>
                        <tr>
                            <td class="texto3">CPF:</td>
                            <td>
                                <font face="arial" color=black><input type="text" name="cpfcnpj" size="35" class='campo1'></font>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <font face="arial" color=black><input type="text" name="assunto" size="20" class='campo1' maxlength='8'></font>
                            </td>
                        </tr>
                        <tr>
                            <td class="texto3">Mensagem:(<font color="#FF0000">*</font>)</td>
                            <td>
                                <font face="arial" color=black><textarea name="mensagem" cols=34 rows=3></textarea>
                            </td>
                            </font>
                        </tr>
                        <tr>
