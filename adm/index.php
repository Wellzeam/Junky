        ...
        <center>
            ...
            <table width="200px" cellpadding="0" cellspacing="5" border="0" bgcolor="#FFFFFF">
                ...
                <tr>
                    ...
                    <td>
                        <font color=black><input class="campo1" name="usuario" type="text" size="15" maxlength="15" /></font>
                    </td>
                </tr>
                <tr>
                    <td align="right" class="texto3">
                    ...
                    <td>
                        <font color=black><input class="campo1" name="senha" type="password" size="15" maxlength="15" /></font>
                    </td>
                </tr>
                <tr><br>
                    <td align="right">&nbsp;</td>
