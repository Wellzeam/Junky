        ...
        <center>
            <div>
                ...
                <table width="800" cellpadding="3" cellspacing="0" border="0">
                    ...
                    <tr height="25px">
                        <td>
                            <font face="Verdana" size="-1" color="#FFFFFF"><?php echo $qtd_usuarios; ?> cliente(s) cadastrado(s) no banco de dados</font>
                        </td>
                        <td align="center">
                            <font face="Verdana" size="-1" color="white">Administração - <a href="logout.php" class="lin dkadm">Sair</a></font>
                        </td>
                    </tr>
                </table>
                <br>
                ...
                <table width="800" cellpadding="2" cellspacing="2" border="1" bordercolor="#999999">
                    <tr bgcolor="#CCCCCC">
                        <td align="center">
                            <font face="Verdana" size="-1" color="#000000">ID</font>
                        </td>
                        <td align="center">
                            <font face="Verdana" size="-1" color="#000000">Nome</font>
                        </td>
                        <td align="center">
                            <font face="Verdana" size="-1" color="#000000">Cidade</font>
                        </td>
                        <td align="center">
                            <font face="Verdana" size="-1" color="#000000">Estado</font>
                        </td>
                        <td align="center">
                            <font face="Verdana" size="-1" color="#000000">E-mail</font>
                        </td>
                    </tr>
                    <?php
                        ...
                        <tr>
                            <td align="left">
                                <font face="Verdana" size="1" color="#000000">
                                    <font color=white><?php echo $l["ID_CLIENTE"]; ?></font>
                                </font>
                            </td>
                            <td align="center">
                                <font face="Verdana" size="1" color="#000000">
                                    <font color=white><?php echo $l["NOME"]; ?></font>
                                </font>
                            </td>
                            <td align="center">
                                <font face="Verdana" size="1" color="#000000">
                                    <font color=white><?php echo $l["CIDADE"]; ?></font>
                                </font>
                            </td>
                            <td align="center">
                                <font face="Verdana" size="1" color="#000000">
                                    <font color=white><?php echo $l["ESTADO"]; ?></font>
                                </font>
                            </td>
                            <td align="center">
                                <font face="Verdana" size="1" color="#000000">
                                    <font color=white><?php echo $l["EMAIL"]; ?></font>
                                </font>
                            </td>
                        </tr>
                    <?php
