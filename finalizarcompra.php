            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <div align="center"><h2>Finalizar Compra</h2>
				</div>
                    </div>
                </div>
            </div>
...
?>
	...
	<table width="620px" cellpadding="0" cellspacing="1" class="tableerro" border="0" align="center" align=center>
		...
		<tr>
			<td width="5%"></td>
			<td align="left"><font class="textoerro">&rsaquo;&nbsp;Caso haja alguma informação errada (Nome, Endereço, E-mail, etc) <a href="contausuario.php" class="link1">clique aqui</a> para alterar.</font></td>
		</tr>
		<tr>
			<td width="5%"></td>
...
<br>
	...
	<table width="650px" cellpadding="0" cellspacing="3" border="0" align=center>
		<tr>
			<td colspan="5"><font class="texto4"><b><h4>Informações do cliente</b></font></td></h4>
			
		</tr>
		<tr>
			<td><font class="texto3"><b>Nome:</b></font></td>
			<td colspan="5"><font class="texto6"><?php echo $nome; ?></font></td>
		</tr>		
		<tr>
			<td><font class="texto3"><b>E-mail:</b></font></td>
			<td colspan="5"><font class="texto6"><?php echo $email; ?></font></td>
		</tr>
		<tr>
			<td><font class="texto3"><b>Telefone:</b></font></td>
			<td><font class="texto6"><?php echo $fone; ?></font></td>
			<td><font class="texto3"><b>Bairro:</b></font></td>
			<td colspan="3"><font class="texto6"><?php echo $bairro; ?></font></td>
		</tr>
		<tr>
			<td><font class="texto3"><b>Endereço:</b></font></td>
			<td><font class="texto6"><?php echo $endereco; ?></font></td>
			<td><font class="texto3"><b>CEP:</b></font></td>
			<td><font class="texto6"><?php echo $cep; ?></font></td>
			
		</tr>
		<tr>
			<td><font class="texto3"><b>Cidade:</b></font></td>
			<td><font class="texto6"><?php echo $cidade; ?></font></td>
			<td><font class="texto3"><b>Estado:</b></font></td>
			<td><font class="texto6"><?php echo $estado; ?></font></td>
			
		</tr>
		<tr>
			<td><font class="texto3"><b>CPF:</b></font></td>
			<td><font class="texto6"><?php echo $cpf; ?></font></td>
			<td><font class="texto3"><b>RG:</b></font></td>
	...
	<table width="650px" cellpadding="0" cellspacing="3" border="0" align=center>
		<tr>
			<td colspan="6"><font class="texto3"><b><h4>Produtos</h4></b></font></td>
		</tr>
		<tr bgcolor="">
			<td width="7%"><font class="texto12"><h5>Código&nbsp;&nbsp;&nbsp;&nbsp;</h5></font></td>
	...
	?>
			...
			<td align="center"><font class="texto10"><?php echo($valor); ?></font></td>
	...
	?>
		...
		<tr>
			<td colspan="6"><font class="texto3">&nbsp;</font></td>
		</tr>
	</table>
	<table width="650px" border="0" cellspacing="3" cellpadding="0" align=center>
		<tr>
			<td width="86%"><font class="texto3"><b><h5>Total da compra:</h5> </b></font></td>
			<td align="center"><font class="erro1"><b><?php if($num_produtos_carrinho == 0){ echo "R$ 0,00";}else{echo "R$".($total_compra);} ?></b></font></td>
		</tr>
	</table>

	<table width="650px" border="0" cellspacing="3" cellpadding="0" align=center>
		<tr>
			<td><font color=""><b><br>Obs: </b></font></td>
			<td><font color=""><br><b>No valor total da compra não está incluso o valor do frete. Para calcular o preço do frete, <a href="http://www.correios.com.br/encomendas/precos/default.cfm" target="_blank" class="link1">clique aqui.</a></font></b></td>
		</tr>
	</table>
	<br>
	...
	<table width="650px" cellpadding="0" cellspacing="4" border="0" align=center>
		<tr>
			<td colspan="6"><font class="texto4"><b></b></font></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td width="30%"><font class="texto3">Boleto</font></td>
		...
		<tr>
			<td align="center" colspan="6"><button type="submit" class="btn btn-default ">Enviar Dados</button></form></td>
		</tr>
	</table>
